...
function test(string) {
  ...
  let string2 = lower.slice(0, 1).toUpperCase();
  console.log('New string:', string2 + lower.slice(1));
}
...
const [status, arrive, depart, time] = a.split(';')
console.log(status, arrive, depart, time);
